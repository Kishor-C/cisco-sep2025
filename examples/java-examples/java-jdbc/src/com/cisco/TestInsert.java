	...
	public static void main(String[] args) {
		try {
			...
			Connection connection = DriverManager
					.getConnection("jdbc:mysql://localhost:3306/cisco_db?useSSL=false", "root", "root");
			/*
			 ...
			 */
			PreparedStatement pstmt = connection.prepareStatement("insert into profile(name, dob) values(?,?)");
