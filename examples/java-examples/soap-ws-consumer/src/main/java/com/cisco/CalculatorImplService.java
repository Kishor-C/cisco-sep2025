 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://cisco.com/", wsdlLocation = "http://localhost:9999/ws/calci?wsdl")
public class CalculatorImplService
    extends Service
{

    private static final URL CALCULATORIMPLSERVICE_WSDL_LOCATION;
    private static final WebServiceException CALCULATORIMPLSERVICE_EXCEPTION;
    private static final QName CALCULATORIMPLSERVICE_QNAME = new QName("http://cisco.com/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/ws/calci?wsdl");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://cisco.com/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cisco.com/", "CalculatorImplPort"), Calculator.class, features);
    }
